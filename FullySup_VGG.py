...
def parse_option():
    ...
    parser.add_argument('--total_epochs', type=int, default=200, help='number of training epochs')
    parser.add_argument('--resume', type=bool, default=False, help='restore checkpoints')
    # optimization
    parser.add_argument('--learning_rate', type=float, default=1e-4, help='learning rate')
    parser.add_argument('--weight_decay', type=float, default=1e-4, help='weight decay')
    # model dataset
    parser.add_argument('--model_name', type=str, default='FullySupVGG')
    # checkpoint
...
def main():
    opt = parse_option()
    tb = SummaryWriter(comment="FullySupVGG")
